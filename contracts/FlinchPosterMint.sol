...
contract FlinchPosterMint is ERC721Enumerable, Ownable {
    ...
    constructor(string memory _name, string memory _symbol) ERC721("FlinchPosterMint", "FPM") {}
    ...
    function info() public view returns (uint256, uint256, uint256, uint256, uint256, bool, bool) {
        return (prePrice, price, totalSupply(), maxSupply, maxMintCount, isPreSaleActive, isPublicSaleActive);
    }
}